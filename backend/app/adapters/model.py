...
class ModelAdapter:
    ...
    async def route_request(
        ...
        system = (
            ...
            "domain-specific Tool is not present, choose data.business.query for an "
            ...
            "Use a stable domain-specific Tool when it provides a special contract, such as "
            "a single purchase-order status, an inbound-state order list or procurement "
            "analytics. For a single order, require order_number and clarify if missing. "
